    ...
    def generate_excel_for_phase(self,phase_name):
        ...
        for block_name,block_details in  self.block_wise_parts_dict.items():
            ...
            for parts_dict in block_details['parts']:
                ...
                sheet.append(["","","","","","","","","","",parts_dict["Part Name"],"",parts_dict['Length (mm)'],parts_dict["Width (mm)"],parts_dict["Thickness (mm)"],parts_dict["Quantity"],int(parts_dict["Quantity"])*phase_qty,yeild,parts_dict["Weight (kg)"]*int(parts_dict["Quantity"]),parts_dict["Area (m2)"]])
